  ...
  return (
   ...
   <h1 className="ml-[50px] lg:mt-[60px] xl:mt-[60px] sm:mt-[2px] md:mt-[2px] text-[yellow] text-[90px]  ">Projects </h1>
         ...
         <h1 className="ml-[50px] text-[#84a314] text-[40px]"> <a href="https://nysquiz.com">NYS QUIZ</a></h1>
               ...
               <h1 className="ml-[50px] text-[#84a314] text-[40px]"> <a href="https://github.com/daiskhan">Github </a></h1>
           <h1 className="ml-[50px] text-[#84a314] text-[40px]"> <a href="https://github.com/daiskhan">Nextjs Projects</a></h1>
           <h1 className="ml-[50px] text-[#84a314] text-[40px]"> <a href="https://github.com/daiskhan">GenAI Projects
</a></h1>
