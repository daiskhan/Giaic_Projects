  ...
  return (
   ...
   <h1 className="name">Projects </h1>
         ...
         <h1 className="intro"> <a href="https://nysquiz.com">NYS QUIZ</a></h1>
               ...
               <h1 className="intro"> <a href="https://github.com/daiskhan">Github </a></h1>
           <h1 className="intro"> <a href="https://github.com/daiskhan">Nextjs Projects</a></h1>
           <h1 className="intro"> <a href="https://github.com/daiskhan">GenAI Projects
</a></h1>
